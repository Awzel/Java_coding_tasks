...
public class PasswordValidation_Zulpikar {
    ...
    2. The Password should at least contain one upper case letter
    3. The Password should at least contain one lowercase letter
